...
>(({ className, children, ...props }, ref) => (
   <SelectPrimitive.Trigger
      ref={ref}
      className={ny(
         'border-input border data-[placeholder]:text-muted-foreground focus:border-ring flex h-9 w-full items-center justify-between rounded-md bg-transparent px-3 py-2 text-left text-sm shadow-sm focus:outline-none focus:border-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 [&>span]:text-left',
         className,
      )}
      onPointerDown={(e) => {
